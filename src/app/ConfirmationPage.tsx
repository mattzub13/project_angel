...
const ConfirmationPage = ({ onReturnToDashboard }: { onReturnToDashboard: () => void }) => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-light_sky p-4">
      <div className="text-center w-full max-w-2xl p-8 bg-white rounded-2xl shadow-2xl">
        ...
        <Button 
          ...
          className="w-full md:w-auto mt-8 p-button-lg bg-blue_green hover:bg-blue_green-400 border-none"
